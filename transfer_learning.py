# Copyright (c) [2012]-[2021] YUAN Li@NUS.
#
# This source code is licensed under the Clear BSD License
# LICENSE file in the root directory of this file
# All rights reserved.

'''Tranfer pretrained vip to downstream dataset: CIFAR10/CIFAR100.'''
import torch
...
if args.transfer_learning:
    print('transfer learning, load vip pretrained model')
...
if args.transfer_learning:
    #print(net)
    print('set different lr for the backbone and classifier(head) of vip')
    parameters = [{'params': net.module.network.parameters(), 'lr': args.transfer_ratio * args.lr},
